...
//         '" class="slide slide--' +
//         numSlide +
//         '">\n\t\t\t\t\t\t\t<div class="slide__darkbg slide--' +
//         numSlide +
//         '__darkbg"></div>\n\t\t\t\t\t\t\t<div class="slide__text-wrapper slide--' +
//         numSlide +
//         '__text-wrapper"></div>\n\t\t\t\t\t\t</div>'
//     );

//     var letter = $(
//       '<div class="slide__letter slide--' +
//         numSlide +
//         '__letter">\n\t\t\t\t\t\t\t' +
//         firstLetter +
//         "\n\t\t\t\t\t\t</div>"
